...
const InvoiceCreate = () => {
  ...
  const [items, setItems] = useState([
    { nama_barang: "", jumlah: 0, harga_satuan: 0, total_harga_item: 0 },
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3000/invoices/create", payload);
      Swal.fire("Berhasil", "Invoice berhasil disimpan", "success");
      navigate("/invoices");
    } catch (err) {
      Swal.fire("Gagal", "Gagal menyimpan invoice", "error");
    }
  };
